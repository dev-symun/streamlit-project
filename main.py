...
places_by_district = {
    ...
    "강동구": ["고덕역", "강동역", "천호역", "길동"],
    "동대문구": ["동대문 관광특구", "DDP(동대문디자인플라자)", "청량리 제기동 일대 전통시장", "왕십리역", "뚝섬역", "청량리역"],
    "서초구": ["교대역", "고속터미널역", "양재역", "사당역", "서초역"],
    # 나머지 구도 필요하면 추가
}
...
if st.button("📡 데이터 불러오기"):
    try:
        ...
        if ppltn is None:
            ...
            lat, lon = coords.get(area_name, (37.5665, 126.9780))  # 기본 서울 중심
